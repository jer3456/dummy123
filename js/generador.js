...
function generar() {
    ...
    for (var i = 0; i < noRegistros; i++) {
        ...
        switch (ap1) {
            case "1":
                var apellido = apellidosRuso[Math.floor(Math.random() * apellidosRuso.length)];
                break;
            case "2":
                var apellido = apellidosEspanol[Math.floor(Math.random() * apellidosEspanol.length)];
                break;
            case "3":
                var apellido = apellidosChino[Math.floor(Math.random() * apellidosChino.length)];
                break;
            case "4":
                var apellido = apellidosFrances[Math.floor(Math.random() * apellidosFrances.length)];
                break;
        }
        switch (ap2) {
            case "1":
                var apellido2 = apellidosRuso[Math.floor(Math.random() * apellidosRuso.length)];
                break;
            case "2":
                var apellido2 = apellidosEspanol[Math.floor(Math.random() * apellidosEspanol.length)];
                break;
            case "3":
                var apellido2 = apellidosChino[Math.floor(Math.random() * apellidosChino.length)];
                break;
            case "4":
                var apellido2 = apellidosFrances[Math.floor(Math.random() * apellidosFrances.length)];
                break;
        }
        switch (name) {
            case "1":
                var nombre = nombresRusos[Math.floor(Math.random() * nombresRusos.length)];
                break;
            case "2":
                var nombre = nombresEspanol[Math.floor(Math.random() * nombresEspanol.length)];
                break;
            case "3":
                var nombre = nombresChino[Math.floor(Math.random() * nombresChino.length)];
                break;
            case "4":
                var nombre = nombresFrances[Math.floor(Math.random() * nombresFrances.length)];
                break;
        }
